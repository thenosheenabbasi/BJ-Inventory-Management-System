<x-app-layout>
    <x-slot name="pageTitle">{{ $isCustomerReport ? 'My Account Report' : 'Payment Summary Report' }}</x-slot>
    <x-slot name="pageBreadcrumb">Home / Reports / {{ $isCustomerReport ? 'My Account Report' : 'Payment Summary Report' }}</x-slot>

    <section class="module-page erp-report-page">
        <div class="erp-report-commandbar">
            @unless ($isCustomerReport)
                <a
            ...
            <form method="GET" action="{{ route('reports.index') }}" class="erp-report-filter {{ $isCustomerReport ? 'customer-report-filter' : '' }}">
                @unless ($isCustomerReport)
        ...
        <div class="erp-report-sheet">
            <header class="erp-report-header">
                <div>
                    ...
                    <h2>{{ $isCustomerReport ? 'My Account Report' : 'Payment Summary Report' }}</h2>
